...
# python live_pn_data.py --model 101 --file rtsp://admin:cctv12345@10.10.2.24:554/Streaming/Channels/1101
# python live_pn_data.py --model 101 --file ./videos_test/test.mp4
